...
public class SwaggerConfiguration {
	...
	public Docket apiPublic() {
		String groupName = "patient_mangement_public";
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Patient Management API Docs").description("Patient Management API Description").version("2.0")
				.build();
	}
}