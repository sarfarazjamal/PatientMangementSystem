...
import com.jamal.patient.management.service.AppointmentQueryService;
...
/**
 * REST controller for managing {@link com.jamal.patient.management.domain.Appointment}.
 */
@RestController
@RequestMapping("/api")
public class AppointmentResource {
    ...
    public ResponseEntity<AppointmentDTO> createAppointment(@RequestBody AppointmentDTO appointmentDTO) throws URISyntaxException {
        ...
        long patientActiveCount=appointmentService.findPatientMaxCapacity(appointmentDTO);
       if(patientActiveCount>3) {
    	   throw new BadRequestAlertException("Patinet can have  max. of 3 active appointments. ", ENTITY_NAME, "");
       }
       long doctorMaxCapacityCount=appointmentService.doctorMaxCapacity(appointmentDTO);
       if(doctorMaxCapacityCount>15) {
    	   throw new BadRequestAlertException("doctor can have  max. of 15 active appointments.Please book with other doctor ", ENTITY_NAME, "");
       }
